...
public class EnemyController : MonoBehaviour
{
    ...
    [Header("Animation")]
    public Animator animtorController;
    ...
    void Start()
    {
        ...
        animtorController = GetComponent<Animator>();
    }
    ...
    void FixedUpdate()
    {
        ...
        if(!HasLOS())
        {
            animtorController.enabled = true;
            animtorController.Play("Run");
            MoveEnemy();
        }
        else
        {
            animtorController.enabled = false;
        }
    }
    ...
    private bool HasLOS()
    {
        ...
        {
            //Case 1 player polygonCollider2D collides with player and player is at the top of the list
